...
def process_area(indicator_name, area, input_foulder, output_foulder):
    ...
    json_land_years_absolute_changes = dirname+'/land-area-affected-by-'+indicator_name+'-absolute-changes_ISIMIP-projections_versus-timeslices_'+area+'.json'
    ...
    json_land_years = dirname+'/land-area-affected-by-'+indicator_name+'_ISIMIP-projections_versus-timeslices_'+area+'.json'
    ...
    json_land_years_relative_changes = dirname+'/land-area-affected-by-'+indicator_name+'-relative-changes_ISIMIP-projections_versus-timeslices_'+area+'.json'
    ...
    json_pop_years_absolute_changes = dirname+'/population-exposed-to-'+indicator_name+'-absolute-changes_ISIMIP-projections_versus-timeslices_'+area+'.json'
    ...
    json_pop_years = dirname+'/population-exposed-to-'+indicator_name+'_ISIMIP-projections_versus-timeslices_'+area+'.json'
    ...
    json_pop_years_relative_changes = dirname+'/population-exposed-to-'+indicator_name+'-relative-changes_ISIMIP-projections_versus-timeslices_'+area+'.json'
    ...
    return AreaReport(
            indicator_short=indicator_short, name=country, code=area,land_indicator_capital=land_indicator_capital,
            ...
            climate_model_list=climate_model_list,impact_model_list=impact_model_list, apostrophe=country_apostrophe,
  ...
  for country_name in country_names:
     if(country_name != 'oceans' and country_name != 'world'):
          ...
          if (country_name != 'world'): 
           ...
           # text = open('templates/test.md').read().format(
