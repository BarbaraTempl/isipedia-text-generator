...
* {country} ranks (ranking-value: land-area-affected-by-drought-relative-changes_ISIMIP-projections_versus-temperature-change_{country_name} value: position temperature:2) with regards to its relative change in land area affected by droughts at 2 degrees Celsius of global warming in comparison to a situation without anthropogenic climate change. For the relative change in population exposed to droughts, {country_apostrophe} ranking is (ranking-value: population-exposed-to-drought-relative-changes_ISIMIP-projections_versus-temperature-change_{country_name} value: position temperature:2).\n\
\n\
### Results\n\
...
\n\
As such, {country} ranks (ranking-value: land-area-affected-by-drought-relative-changes_ISIMIP-projections_versus-temperature-change_{country_name} value: position temperature:2) with regards to its relative change in land area affected by droughts at 2 degrees Celsius of global warming in comparison to a situation without anthropogenic climate change. For the relative change in land area affected by droughts towards the-end-of-the-century under a higher-emissions scenario (RCP6.0), {country_apostrophe} ranking is (ranking-value: land-area-affected-by-drought-relative-changes_ISIMIP-projections_versus-timeslices_{country_name} value: position time:2081-2100 scenario: rcp60).\n\
\n\
#### Population exposed to droughts\n\
\n\
...
\n\
As such, {country} ranks (ranking-value: population-exposed-to-drought-relative-changes_ISIMIP-projections_versus-temperature-change_{country_name} value: position temperature:2) with regards to its relative change in population exposed to droughts at 2 degrees Celsius of global warming in comparison to a situation without anthropogenic climate change. For the relative change in population exposed to droughts towards the-end-of-the-century under a business-as-usual emissions scenario, {country_apostrophe} ranking is (ranking-value: population-exposed-to-drought-relative-changes_ISIMIP-projections_versus-timeslices_{country_name} value: position time:2081-2100 scenario: rcp60).\n\
\n\
### Methodology\n\
\n\
#### What do we analyze?\n\
